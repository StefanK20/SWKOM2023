...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DocTag : IEquatable<DocTag>, IValidatableObject
    {
        ...
        public DocTag(long id = default(long), string slug = default(string), string name = default(string), string color = default(string), string match = default(string), long matchingAlgorithm = default(long), bool isInsensitive = default(bool), bool isInboxTag = default(bool), long documentCount = default(long))
        {
            this.Id = id;
            this.Slug = slug;
            this.Name = name;
        ...
        {
            return this.Equals(input as DocTag);
        }

        /// <summary>
        /// Returns true if DocTag instances are equal
        /// </summary>
        /// <param name="input">Instance of DocTag to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocTag input)
        {
            if (input == null)
            {
                return false;
