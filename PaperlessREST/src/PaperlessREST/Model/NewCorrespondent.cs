...
namespace Org.OpenAPITools.Model
{
    ...
    /// NewCorrespondent
    /// </summary>
    [DataContract(Name = "NewCorrespondent")]
    public partial class NewCorrespondent : IEquatable<NewCorrespondent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewCorrespondent" /> class.
        /// </summary>
        ...
        public NewCorrespondent(string name = default(string), string match = default(string), long matchingAlgorithm = default(long), bool isInsensitive = default(bool), long documentCount = default(long), DateTime lastCorrespondence = default(DateTime))
        {
            this.Name = name;
            this.Match = match;
        ...
        {
            return this.Equals(input as NewCorrespondent);
        }

        /// <summary>
        /// Returns true if NewCorrespondent instances are equal
        /// </summary>
        /// <param name="input">Instance of NewCorrespondent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewCorrespondent input)
        {
            if (input == null)
            {
                return false;
